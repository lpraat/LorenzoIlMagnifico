...
/**
 * This class represents a dynamic effect that adds value to an Action in a harvest place.
 */
public class HarvestChange implements DynamicEffect, Serializable {
    ...
    /**
     * Creates a new HarvestChange effect.
     * @param value the value of the change.
     */
    public HarvestChange(int value) {
        this.value = value;
    }
    ...
    public String toString() {
        return "Adds " + value + " value to an action done in a harvest place";
    }
